...
```notes
  - Talk about space and color API
...
<Box m={2} p={4} bg='red' color='rebeccapurple'>
  {children}
</Box>

<Box py={2}  mx={1} bg='red' color='rebeccapurple'>
  {children}
</Box>
...
- Defaults to px (if you supply you're own breakpoints) but you can change the unit type
